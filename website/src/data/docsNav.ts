...
export const docsNav: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Git Worktrees", href: "/guides/worktrees/", description: "How BOA creates and cleans up a git worktree per session." },
      ...
      { title: "Shell Completions", href: "/guides/shell-completions/", description: "Install and refresh tab-completion for the boa CLI." },
